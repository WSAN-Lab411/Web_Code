...
<div id="wrap">
    ...
    <div id="mainpage">
        ...
        Ngày :
        <select name="ngay" class="span1" >
        <?php
        $ngay=1;
        while($ngay<10)
        {       $haha="0".$ngay;
            	echo '<option value="'.$haha.'" >';
		      echo $haha.'</option>';
              $ngay++;
        }
          while($ngay<32)
        ...
        ?>
		    ...
		    <br/><br/>
            <input type="submit" name="Timkiem" value="Tìm Kiếm" style="position: absolute; height: 30; width: 100; " />
	</div>
	     <div id="right_con">
